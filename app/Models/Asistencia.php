...
class Asistencia {
    ...
    // Cargar expedientes para el menú desplegable del formulario
    ...
    // Obtener SOLO las asistencias ya registradas en una fecha específica
    ...
    // Guardar o actualizar la asistencia individual
